...
t_matrix	mainv(t_matrix m)
{
	...
	o.x[1] = ((m.y[0] * m.z[2]) - (m.z[0] * m.y[2])) / d;
	o.x[2] = ((m.y[0] * m.z[1]) - (m.z[0] * m.y[1])) / d;
	o.y[0] = ((m.x[1] * m.z[2]) - (m.z[1] * m.x[2])) / d;
	o.y[1] = ((m.x[0] * m.z[2]) - (m.z[0] * m.x[2])) / d;
	o.y[2] = ((m.x[0] * m.z[1]) - (m.z[0] * m.x[1])) / d;
	o.z[0] = ((m.x[1] * m.y[2]) - (m.y[1] * m.x[2])) / d;
	o.z[1] = ((m.x[0] * m.y[2]) - (m.y[0] * m.x[2])) / d;
