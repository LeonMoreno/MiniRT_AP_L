...
/*   Updated: 2022/09/14 16:23:16 by agrenon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_vec	apply_matrices(t_vec vec, t_vec o)
{
	return (transform(transform(transform
				(vec, rotate_z(o.z)), rotate_y(o.y)), rotate_x(o.x)));
}

t_vec	apply_matrices_r(t_vec vec, t_vec o)
{
	return (transform_r(transform_r
			(transform_r(vec, rotate_x(o.x)), rotate_y(o.y)), rotate_z(o.z)));
}
